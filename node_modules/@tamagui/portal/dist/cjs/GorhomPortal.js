...
function PortalHostWeb(props) {
  ...
  return (0, import_react.useEffect)(() => (setMounted(!0), () => {
    setMounted(!1), import_constants2.allPortalHosts.delete(props.name);
  }), [props.name]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      style: { display: "contents" },
      ref: (node) => {
        node && mounted && (import_constants2.allPortalHosts.set(props.name, node), import_constants2.portalListeners[props.name]?.forEach((x) => x(node)));
      }
    }
  );
}
