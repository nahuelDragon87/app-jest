...
var require_insertStyleRule_native = __commonJS({
  "../web/dist/cjs/helpers/insertStyleRule.native.js"(exports2, module2) {
    ...
    var import_constants2 = require_index_native2(), import_helpers = require_index_native3(), import_createVariable = require_createVariable_native(), scannedCache = /* @__PURE__ */ new WeakMap(), totalSelectorsInserted = /* @__PURE__ */ new Map(), allSelectors = {}, allRules = {}, insertedTransforms2 = {}, getAllSelectors = function() {
      return allSelectors;
    }, getAllRules = function() {
    ...
    function getTamaguiSelector(rule) {
      ...
      if (rule instanceof CSSStyleRule) {
        ...
        if (text[0] === ":" && text[1] === "r") {
          if (text.startsWith(":root ._")) return [
    ...
    var getSplitStyles = function(props, staticConfig, theme, themeName, componentState, styleProps, parentSplitStyles, context, elementType, debug) {
      ...
      for (var keyOg in props) {
        var _loop = function(i2) {
          ...
          if (shouldPassThrough2) return passDownProp(viewProps, key, val, isMediaOrPseudo1), process.env.NODE_ENV === "development" && debug === "verbose" && (consoleGroupCollapsed(` - passing down prop ${key}`), (0, import_log.log)({
            val,
            after: {
              ...viewProps[key]
            }
          ...
          if (isMedia) {
            ...
            if (process.env.NODE_ENV === "development" && debug === "verbose" && (0, import_log.log)(`  \u{1F4FA} ${key}`, {
              ...
              if (!isThemeMedia && !isPlatformMedia && !isGroupMedia) {
                if (!mediaState2[mediaKeyShort]) return process.env.NODE_ENV === "development" && debug === "verbose" && (0, import_log.log)(`  \u{1F4FA} \u274C DISABLED ${mediaKeyShort}`), "continue";
