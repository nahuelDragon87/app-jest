...
var require_createVariable_native = __commonJS({
  "../web/dist/cjs/createVariable.native.js"(exports2, module2) {
    ...
    var import_constants2 = require_index_native2(), import_helpers = require_index_native3(), import_config = require_config_native();
...
var require_insertStyleRule_native = __commonJS({
  "../web/dist/cjs/helpers/insertStyleRule.native.js"(exports2, module2) {
    ...
    var import_constants2 = require_index_native2(), import_helpers = require_index_native3(), import_createVariable = require_createVariable_native(), totalSelectorsInserted = /* @__PURE__ */ new Map(), allSelectors = {}, allRules = {}, insertedTransforms2 = {}, getAllSelectors = function() {
      return allSelectors;
    }, getAllRules = function() {
  ...
  "../web/dist/cjs/helpers/ThemeManager.native.js"(exports2, module2) {
    ...
    function getState(props, manager) {
      ...
      for (var base = baseName.split(import_constants22.THEME_NAME_SEPARATOR), max = base.length, min = props.componentName && !nextName ? max : (
        ...
        if (typeof props.debug == "string" && import_constants2.isClient && console.info(` \u{1F537} [${manager == null ? void 0 : manager.id}] getState`, {
          props,
          found,
          potentials,
          baseManager,
      ...
      return props.debug === "verbose" && import_constants2.isClient && (console.groupCollapsed("ThemeManager.getState()"), console.info({
        props,
        baseName,
        base,
        min,
...
var require_ThemeManagerContext_native = __commonJS({
  "../web/dist/cjs/helpers/ThemeManagerContext.native.js"(exports2, module2) {
    ...
    __export2(ThemeManagerContext_exports, {
      ThemeManagerIDContext: function() {
        return ThemeManagerIDContext;
      }
    });
...
var require_useTheme_native = __commonJS({
  "../web/dist/cjs/hooks/useTheme.native.js"(exports2, module2) {
    ...
    var import_react3 = __toESM2(require("react")), import_constants2 = require_index_native2(), import_config = require_config_native(), import_createVariable = require_createVariable_native(), import_ThemeManager = require_ThemeManager_native(), import_ThemeManagerContext = require_ThemeManagerContext_native(), import_createShallowSetState = require_createShallowSetState_native(), import_shouldDeoptDueToParentScheme = require_shouldDeoptDueToParentScheme_native(), emptyProps = {
      name: null
    }, cached;
    ...
    var activeThemeManagers = /* @__PURE__ */ new Set(), _uidToManager = /* @__PURE__ */ new WeakMap(), _idToUID = {}, getId = function(id) {
      ...
      function createState(prev) {
        ...
        if (prev && (shouldUpdate == null ? void 0 : shouldUpdate()) === !1 && !force) return prev;
...
var require_Tamagui_native = __commonJS({
  "../web/dist/cjs/Tamagui.native.js"(exports2, module2) {
    ...
    var Helpers = __toESM2(require_index_native3()), import_config = require_config_native(), import_insertStyleRule = require_insertStyleRule_native(), import_useMedia = require_useMedia_native(), import_useTheme = require_useTheme_native(), Tamagui = function() {
      if (0)
        var TamaguiManager;
...
var require_normalizeValueWithProperty_native = __commonJS({
  "../web/dist/cjs/helpers/normalizeValueWithProperty.native.js"(exports2, module2) {
    ...
    var import_constants2 = require_index_native2(), import_helpers = require_index_native3(), import_insertStyleRule = require_insertStyleRule_native(), stylePropsAllPlusTransforms = {
...
var require_expandStyle_native = __commonJS({
  "../web/dist/cjs/helpers/expandStyle.native.js"(exports2, module2) {
    ...
    var import_constants2 = require_index_native2(), import_webToNativeProps = require_webToNativeProps_native(), import_config = require_config_native(), _loop = function(parent2) {
      var _exec, _exec_index, prefix = parent2.slice(0, (_exec_index = (_exec = /[A-Z]/.exec(parent2)) === null || _exec === void 0 ? void 0 : _exec.index) !== null && _exec_index !== void 0 ? _exec_index : parent2.length);
...
var require_propMapper_native = __commonJS({
  "../web/dist/cjs/helpers/propMapper.native.js"(exports2, module2) {
    ...
    __export2(propMapper_exports, {
      ...
      getPropMappedFontFamily: function() {
        return getPropMappedFontFamily;
      },
...
var require_Theme_native = __commonJS({
  "../web/dist/cjs/views/Theme.native.js"(exports2, module2) {
    ...
    var import_jsx_runtime = require("react/jsx-runtime"), import_constants2 = require_index_native2(), import_react3 = __toESM2(require("react")), import_createVariable = require_createVariable_native(), import_ThemeManagerContext = require_ThemeManagerContext_native(), import_useTheme = require_useTheme_native(), import_ThemeDebug = require_ThemeDebug_native(), import_log = require_log_native(), Theme = /* @__PURE__ */ (0, import_react3.forwardRef)(function(param, ref) {
...
var require_wrapStyleTags_native = __commonJS({
  "../web/dist/cjs/helpers/wrapStyleTags.native.js"(exports2, module2) {
    ...
    var import_jsx_runtime = require("react/jsx-runtime"), import_helpers = require_index_native3();
...
var require_Slot_native = __commonJS({
  "../web/dist/cjs/views/Slot.native.js"(exports2, module2) {
    ...
    var import_jsx_runtime = require("react/jsx-runtime"), import_compose_refs = require_index_native5(), import_constants2 = require_index_native2(), import_helpers = require_index_native3(), import_react3 = require("react"), is19 = import_react3.version.startsWith("19."), Slot = /* @__PURE__ */ (0, import_react3.memo)(/* @__PURE__ */ (0, import_react3.forwardRef)(function(props, forwardedRef) {
...
var require_createVariables_native = __commonJS({
  "../web/dist/cjs/createVariables.native.js"(exports2, module2) {
    ...
    var import_helpers = require_index_native3(), import_createVariable = require_createVariable_native(), cache2 = /* @__PURE__ */ new WeakMap(), createVariables = function(tokens) {
...
var require_useThemeName_native = __commonJS({
  "../web/dist/cjs/hooks/useThemeName.native.js"(exports2, module2) {
    ...
    var import_react3 = __toESM2(require("react")), import_constants2 = require_index_native2(), import_ThemeManagerContext = require_ThemeManagerContext_native(), import_useTheme = require_useTheme_native();
...
var require_Stack_native = __commonJS({
  "../web/dist/cjs/views/Stack.native.js"(exports2, module2) {
    ...
    var import_helpers = require_index_native3(), import_constants2 = require_constants_native2(), import_createComponent = require_createComponent_native(), Stack2 = (0, import_createComponent.createComponent)({
      acceptsClassName: !0,
...
var require_View_native = __commonJS({
  "../web/dist/cjs/views/View.native.js"(exports2, module2) {
    ...
    var import_helpers = require_index_native3(), import_constants2 = require_constants_native2(), import_createComponent = require_createComponent_native(), View2 = (0, import_createComponent.createComponent)({
      acceptsClassName: !0,
      defaultProps: import_constants2.stackDefaultStyles,
      validStyles: import_helpers.validStyles
    });
...
var require_Text_native = __commonJS({
  "../web/dist/cjs/views/Text.native.js"(exports2, module2) {
    ...
    var import_helpers = require_index_native3(), import_createComponent = require_createComponent_native(), ellipsisStyle = {
      numberOfLines: 1,
      lineBreakMode: "clip"
...
function createOptimizedView(children, viewProps, baseViews2) {
  ...
  var style = Array.isArray(viewProps.style) ? baseViews2.StyleSheet.flatten(viewProps.style) : viewProps.style, newPointerEvents = (style == null ? void 0 : style.pointerEvents) || pointerEvents, finalProps = viewProps, extras = {
