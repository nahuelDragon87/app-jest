...
function TouchableWithoutFeedback(props, forwardedRef) {
  ...
  } = props, hostRef = useRef(null), pressConfig = useMemo(
    () => ({
  ...
  ), pressEventHandlers = usePressEvents(hostRef, pressConfig), element = React.Children.only(props.children), children = [element.props.children], supportedProps = pickProps(props);
