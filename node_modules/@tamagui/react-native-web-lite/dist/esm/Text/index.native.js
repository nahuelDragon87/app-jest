...
import { TextAncestorContext, getLocaleDirection } from "@tamagui/react-native-web-internals";
import { forwardPropsListText, pick, useElementLayout, useLocaleContext, useMergeRefs, usePlatformMethods, useResponderEvents } from "@tamagui/react-native-web-internals";
...
var pickProps = function(props) {
  ...
  var handleClick = React.useCallback(function(e) {
    ...
    onClick,
    onPress
  ]), component = hasTextAncestor ? "span" : "div", langDirection = props.lang != null ? getLocaleDirection(props.lang) : null, componentDirection = props.dir || langDirection, writingDirection = componentDirection || contextDirection, supportedProps = pickProps(rest);
