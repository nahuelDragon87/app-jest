...
var React = __toESM(require("react")), import_react = require("react"), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), forwardPropsList = {
  ...
  return (0, import_react_native_web_internals.pick)(props, forwardPropsList);
};
function TouchableWithoutFeedback(props, forwardedRef) {
  var { delayPressIn, delayPressOut, delayLongPress, disabled, focusable, onLongPress, onPress, onPressIn, onPressOut, rejectResponderTermination } = props, hostRef = (0, import_react.useRef)(null), pressConfig = (0, import_react.useMemo)(function() {
    return {
  ...
  ]), pressEventHandlers = (0, import_react_native_web_internals.usePressEvents)(hostRef, pressConfig), element = React.Children.only(props.children), children = [
