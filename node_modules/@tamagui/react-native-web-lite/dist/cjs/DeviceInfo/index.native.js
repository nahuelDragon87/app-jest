...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_Dimensions = __toESM(require("../Dimensions/index")), DeviceInfo = {
  Dimensions: {
    get windowPhysicalPixels() {
      var { width, height, fontScale, scale } = import_Dimensions.default.get("window");
      return {
        width: width * scale,
        height: height * scale,
        scale,
    ...
    get screenPhysicalPixels() {
      var { width: width1, height: height1, fontScale: fontScale1, scale: scale1 } = import_Dimensions.default.get("screen");
      return {
        width: width1 * scale1,
