...
var import_jsx_runtime = require("react/jsx-runtime"), React = __toESM(require("react")), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_View = __toESM(require("../View/index")), createSvgCircle = function(style) {
  ...
  var { animating = !0, color = "#1976D2", hidesWhenStopped = !0, size = "small", style, ...other } = props, svg = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
    height: "100%",
    viewBox: "0 0 32 32",
    width: "100%",
    children: [
