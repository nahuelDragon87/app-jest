...
var import_createForOfIteratorHelperLoose = __toESM(require("@babel/runtime/helpers/createForOfIteratorHelperLoose")),
  ...
  import_useRefEffect = __toESM(require("../useRefEffect.cjs")),
  import_AnimatedEvent = require("./AnimatedEvent.cjs"),
  import_NativeAnimatedHelper = __toESM(require("./NativeAnimatedHelper.cjs")),
  import_AnimatedProps = __toESM(require("./nodes/AnimatedProps.cjs"));
const useLayoutEffect = typeof window > "u" ? import_react.useEffect : import_react.useLayoutEffect;
function useAnimatedProps(props) {
  var _useReducer = (0, import_react.useReducer)(count => count + 1, 0),
    scheduleUpdate = _useReducer[1],
    onUpdateRef = (0, import_react.useRef)(null),
    node = (0, import_react.useMemo)(() => new import_AnimatedProps.default(props, () => onUpdateRef.current == null ? void 0 : onUpdateRef.current()), [props]);
  useAnimatedPropsLifecycle(node);
  var refEffect = (0, import_react.useCallback)(instance => {
