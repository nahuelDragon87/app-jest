...
var AnimatedMultiplication = /* @__PURE__ */ function(AnimatedWithChildren2) {
  ...
  function AnimatedMultiplication2(a, b) {
    ...
    var _this;
    return _this = _call_super(this, AnimatedMultiplication2), _this._a = typeof a == "number" ? new import_AnimatedValue.default(a) : a, _this._b = typeof b == "number" ? new import_AnimatedValue.default(b) : b, _this;
  }
...
}(import_AnimatedWithChildren.default), AnimatedMultiplication_default = AnimatedMultiplication;
