...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_NativeAnimatedHelper = __toESM(require("../NativeAnimatedHelper")), NativeAnimatedAPI = import_NativeAnimatedHelper.default.API, _uniqueId = 1;
class AnimatedNode {
  __attach() {
  }
  __detach() {
