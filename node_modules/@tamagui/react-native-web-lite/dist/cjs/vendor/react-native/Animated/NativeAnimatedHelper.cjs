...
var import_react_native_web_internals = require("@tamagui/react-native-web-internals"),
  import_FeatureFlags = require("../FeatureFlags.cjs"),
  import_NativeEventEmitter = __toESM(require("../NativeEventEmitter/index.cjs")),
  import_RCTDeviceEventEmitter = __toESM(require("../NativeEventEmitter/RCTDeviceEventEmitter.cjs")),
  import_NativeAnimatedModule = __toESM(require("./NativeAnimatedModule.cjs")),
  import_NativeAnimatedTurboModule = __toESM(require("./NativeAnimatedTurboModule.cjs")),
  NativeAnimatedModule = import_react_native_web_internals.Platform.OS === "ios" && global.RN$Bridgeless === !0 ? import_NativeAnimatedTurboModule.default : import_NativeAnimatedModule.default,
  __nativeAnimatedNodeTagCount = 1,
...
function validateStyles(styles) {
  for (var _key2 in styles) if (!isSupportedStyleProp(_key2)) throw new Error("Style property '" + _key2 + "' is not supported by native animated module");
}
function validateInterpolation(config) {
  for (var _key3 in config) if (!isSupportedInterpolationParam(_key3)) throw new Error("Interpolation property '" + _key3 + "' is not supported by native animated module");
}
...
var NativeAnimatedHelper_default = {
  ...
  get nativeEventEmitter() {
    ...
    import_react_native_web_internals.Platform.OS !== "ios" ? null : NativeAnimatedModule)), nativeEventEmitter;
  }
};