...
var React = __toESM(require("react")),
  ...
  import_useAnimatedProps = __toESM(require("./useAnimatedProps.cjs"));
function createAnimatedComponent(Component) {
  return /* @__PURE__ */React.forwardRef((props, forwardedRef) => {
    var _useAnimatedProps = (0, import_useAnimatedProps.default)(props),
      reducedProps = _useAnimatedProps[0],
      callbackRef = _useAnimatedProps[1],
      ref = (0, import_react_native_web_internals.useMergeRefs)(callbackRef, forwardedRef),
