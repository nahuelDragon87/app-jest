...
function useWindowDimensions() {
  var [dims, setDims] = import_react.default.useState(function() {
    return import_Dimensions.default.get("window");
  });
  return import_react.default.useEffect(function() {
    ...
    return import_Dimensions.default.addEventListener("change", handleChange), setDims(import_Dimensions.default.get("window")), function() {
