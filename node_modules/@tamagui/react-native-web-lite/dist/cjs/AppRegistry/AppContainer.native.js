...
var import_jsx_runtime = require("react/jsx-runtime"), React = __toESM(require("react")), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_View = __toESM(require("../View/index")), RootTagContext = /* @__PURE__ */ React.createContext(null), AppContainer = /* @__PURE__ */ React.forwardRef(function(props, forwardedRef) {
  var { children, WrapperComponent } = props, innerView = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_View.default, {
...
var AppContainer_default = AppContainer, styles = import_react_native_web_internals.StyleSheet.create({
  appContainer: {
    flex: 1
  }
});
