...
var import_react = __toESM(require("react")), import_server = __toESM(require("react-dom/server")), import_StyleSheet = __toESM(require("../../StyleSheet/index")), import_View = __toESM(require("../../View")), import__ = __toESM(require("..")), NoopComponent = function() {
...
describe("AppRegistry", function() {
  describe("getApplication", function() {
    test("does not throw when missing appParameters", function() {
      import__.default.registerComponent("App", function() {
        return NoopComponent;
      }), expect(function() {
        return import__.default.getApplication("App");
      }).not.toThrow();
    }), test('returns "element" and "getStyleElement"', function() {
      import__.default.registerComponent("App", function() {
        return NoopComponent;
      });
      var { element, getStyleElement } = import__.default.getApplication("App", {}), styleElement = import_server.default.renderToStaticMarkup(getStyleElement());
      ...
      var { getStyleElement } = import__.default.getApplication("App", {}), styleElement = getStyleElement({
        nonce
      });
      ...
      var getApplicationStyles = function(appName) {
        var { getStyleElement } = import__.default.getApplication(appName, {});
        return getStyleElement().props.dangerouslySetInnerHTML.__html;
      }, RootComponent = function() {
        return /* @__PURE__ */ import_react.default.createElement(import_View.default);
      };
      import__.default.registerComponent("App", function() {
      ...
      `);
      var styles = import_StyleSheet.default.create({
        root: {
          borderWidth: 1234,
      ...
      import__.default.registerComponent("AlternativeApp", function() {
      ...
      expect(second).toMatchInlineSnapshot(`
        ...
        .r-top-ipm5af{top:0px;}"
      `);
      var third = getApplicationStyles("App");
