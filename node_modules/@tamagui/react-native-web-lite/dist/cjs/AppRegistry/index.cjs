...
class AppRegistry {
  ...
  static registerComponent(appKey, componentProvider) {
    return runnables[appKey] = {
      ...
      run: appParameters => (0, import_renderApplication.default)(componentProviderInstrumentationHook(componentProvider), wrapperComponentProvider && wrapperComponentProvider(appParameters), appParameters.callback, {
