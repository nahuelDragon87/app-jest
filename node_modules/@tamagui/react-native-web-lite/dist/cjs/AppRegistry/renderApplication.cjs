...
function renderApplication(RootComponent, WrapperComponent = null, callback = () => {}, options) {
  const {
    ...
    renderFn = shouldHydrate ? mode === "concurrent" ? import_render.hydrate : import_render.hydrateLegacy : mode === "concurrent" ? import_render.render : import_render.default;
...
function getApplication(RootComponent, initialProps, WrapperComponent) {
  return {
    element: /* @__PURE__ */(0, import_jsx_runtime.jsx)(import_AppContainer.default, {
      WrapperComponent,
      rootTag: {},
      children: /* @__PURE__ */(0, import_jsx_runtime.jsx)(RootComponent, {
        ...initialProps
