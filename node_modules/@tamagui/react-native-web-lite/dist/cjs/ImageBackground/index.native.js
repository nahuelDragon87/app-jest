...
var import_jsx_runtime = require("react/jsx-runtime"), React = require("react"), import_react = require("react"), import_react_native_web_internals = require("@tamagui/react-native-web-internals"), import_Image = __toESM(require("../Image/index")), import_View = __toESM(require("../View/index")), emptyObject = {}, ImageBackground = /* @__PURE__ */ (0, import_react.forwardRef)(function(props, forwardedRef) {
  var { children, style = emptyObject, imageStyle, imageRef, ...rest } = props, { height, width } = import_react_native_web_internals.StyleSheet.flatten(style);
