...
var stylesFromProps = /* @__PURE__ */ new WeakMap(), createDOMProps = function(elementType, props, options) {
  ...
  var stylesAtomic = (0, import_web.getStylesAtomic)(flat);
  stylesFromProps.set(domProps, stylesAtomic), domProps.style = stylesAtomic.reduce(function(acc, param) {
    var [key, value] = param;
    return key[0] === "_" || key.startsWith("is_") || key.startsWith("font_") ? (className += ` ${key}`, acc) : (key === "$$css" || key === "" || (acc[key] = value), acc);
  }, {}), className && (domProps.className = className);
