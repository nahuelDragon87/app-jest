...
var import_jsx_runtime = require("react/jsx-runtime"), import_dom_event_testing_library = require("dom-event-testing-library"), React = __toESM(require("react")), ReactDOM = __toESM(require("react-dom")), ReactDOMServer = __toESM(require("react-dom/server")), import_test_utils = require("react-dom/test-utils"), import__ = __toESM(require(".."));
...
describe("create-event-handle", function() {
  ...
  beforeEach(function() {
    ...
    var listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click");
    function Component() {
    ...
    var output = ReactDOMServer.renderToString(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {}));
    ...
    test("event dispatched on target", function() {
      ...
      var listener = jest.fn(), listenerCapture = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), parentRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click"), addClickCaptureListener = (0, import__.default)("click", {
        capture: !0
      });
      function Component() {
        return React.useEffect(function() {
      ...
      var log = [], listener = jest.fn(function() {
        ...
        log.push("capture");
      }), targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click"), addClickCaptureListener = (0, import__.default)("click", {
        capture: !0
      });
      function Component() {
        return React.useEffect(function() {
      ...
      var listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click");
      function Component() {
        return React.useEffect(function() {
          return addClickListener(targetRef.current, listener);
        }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
      ...
      var listener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), addMagicEventListener = (0, import__.default)("magic-event");
      function Component() {
        return React.useEffect(function() {
      ...
      var log = [], targetRef = /* @__PURE__ */ React.createRef(), parentRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click"), addClickCaptureListener = (0, import__.default)("click", {
        capture: !0
      ...
      var log = [], targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click"), addClickAltListener = (0, import__.default)("click"), addClickCaptureListener = (0, import__.default)("click", {
        capture: !0
    ...
    test("stopPropagation works as expected", function() {
      var childListener = jest.fn(function(e) {
        e.stopPropagation();
      }), targetListener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), childRef = /* @__PURE__ */ React.createRef(), addClickListener = (0, import__.default)("click");
      function Component() {
        return React.useEffect(function() {
      ...
      }), secondListener = jest.fn(), targetRef = /* @__PURE__ */ React.createRef(), addFirstClickListener = (0, import__.default)("click"), addSecondClickListener = (0, import__.default)("click");
      function Component() {
        return React.useEffect(function() {
