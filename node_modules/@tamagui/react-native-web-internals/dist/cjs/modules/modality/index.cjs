...
const listeners = /* @__PURE__ */new Set(),
  ...
  addBlurListener = (0, import_createEventHandle.default)(BLUR, bubbleOptions),
  addFocusListener = (0, import_createEventHandle.default)(FOCUS, bubbleOptions),
  addVisibilityChangeListener = (0, import_createEventHandle.default)(VISIBILITYCHANGE, captureOptions),
  addKeyDownListener = (0, import_createEventHandle.default)(KEYDOWN, captureOptions),
  addPointerDownListener = (0, import_createEventHandle.default)(POINTERDOWN, captureOptions),
  addPointerMoveListener = (0, import_createEventHandle.default)(POINTERMOVE, captureOptions),
  addContextMenuListener = (0, import_createEventHandle.default)(CONTEXTMENU, captureOptions),
  addMouseDownListener = (0, import_createEventHandle.default)(MOUSEDOWN, captureOptions),
  addMouseMoveListener = (0, import_createEventHandle.default)(MOUSEMOVE, captureOptions),
  addMouseUpListener = (0, import_createEventHandle.default)(MOUSEUP, captureOptions),
  addScrollListener = (0, import_createEventHandle.default)(SCROLL, captureOptions),
  addSelectiomChangeListener = (0, import_createEventHandle.default)(SELECTIONCHANGE, captureOptions),
  addTouchCancelListener = (0, import_createEventHandle.default)(TOUCHCANCEL, captureOptions),
  addTouchMoveListener = (0, import_createEventHandle.default)(TOUCHMOVE, captureOptions),
  addTouchStartListener = (0, import_createEventHandle.default)(TOUCHSTART, captureOptions);
