...
var import_jsx_runtime = require("react/jsx-runtime"), React = require("react"), ReactDOM = __toESM(require("react-dom")), import_test_utils = require("react-dom/test-utils"), import__ = __toESM(require(".."));
...
describe("useStable", function() {
  var root, rootNode, spy = {}, TestComponent = function(param) {
    var { initialValueCallback } = param, value = (0, import__.default)(initialValueCallback);
  ...
  beforeEach(function() {
    ...
    }), expect(spy.value).toBe(0), (0, import_test_utils.act)(function() {
      root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TestComponent, {
        initialValueCallback
      }));
    ...
    }), expect(counter).toBe(1), (0, import_test_utils.act)(function() {
      root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TestComponent, {
        initialValueCallback
      }));
    ...
    }), expect(spy.value).toBe(null), (0, import_test_utils.act)(function() {
      root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TestComponent, {
        initialValueCallback
      }));
