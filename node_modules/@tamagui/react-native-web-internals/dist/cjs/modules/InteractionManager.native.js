...
var import_requestIdleCallback = __toESM(require("./requestIdleCallback")), InteractionManager = {
  Events: {
  ...
  */
  runAfterInteractions(task) {
    var handle, promise = new Promise(function(resolve) {
      handle = (0, import_requestIdleCallback.default)(function() {
