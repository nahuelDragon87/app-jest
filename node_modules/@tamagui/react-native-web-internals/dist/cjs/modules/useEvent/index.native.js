...
function useEvent(event, options) {
  var targetListeners = (0, import_useStable.default)(function() {
    return /* @__PURE__ */ new Map();
  }), addListener = (0, import_useStable.default)(function() {
    var addEventListener = (0, import_createEventHandle.default)(event, options);
    return function(target, callback) {
      var removeTargetListener = targetListeners.get(target);
      removeTargetListener != null && removeTargetListener(), callback == null && targetListeners.delete(target);
  ...
  return (0, import_useLayoutEffect.default)(function() {
    return function() {
