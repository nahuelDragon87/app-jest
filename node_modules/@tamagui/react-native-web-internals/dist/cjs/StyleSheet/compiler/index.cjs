...
var import_simple_hash = require("@tamagui/simple-hash"),
  import_createReactDOMStyle = __toESM(require("./createReactDOMStyle.cjs")),
  import_hyphenateStyleName = __toESM(require("./hyphenateStyleName.cjs")),
...
function createDeclarationBlock(style) {
  ...
  return `{${Object.keys(domStyle).map(property => {
    const value = domStyle[property],
      prop = (0, import_hyphenateStyleName.default)(property);
