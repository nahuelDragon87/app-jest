...
var import_core = require("@tamagui/core"), createInterFont = function() {
  var font = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { sizeLineHeight = function(size2) {
    return size2 + 10;
  }, sizeSize = function(size2) {
    return size2 * 1;
  } } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, size = Object.fromEntries(Object.entries({
    ...defaultSizes,
    ...font.size
  }).map(function(param) {
    var [k, v] = param;
