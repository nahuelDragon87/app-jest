...
function useMedia(cc, debug) {
  var disableSSR = getSetting("disableSSR") || getDisableSSR(cc), isHydrated = useDidFinishSSR(), initialState = isHydrated || disableSSR || !isWeb ? mediaState : initState, [state, setState] = React.useState(initialState);
