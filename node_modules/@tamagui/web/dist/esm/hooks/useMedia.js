...
function useMedia(cc, debug) {
  const disableSSR = getSetting("disableSSR") || getDisableSSR(cc), initialState = useDidFinishSSR() || disableSSR || !isWeb ? mediaState : initState, [state, setState] = React.useState(initialState);
