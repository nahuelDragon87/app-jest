...
var import_theme_builder = require("@tamagui/theme-builder"), import_color2k = require("color2k"), import_getThemeSuitePalettes = require("./getThemeSuitePalettes"), import_v4_defaultTemplates = require("./v4-defaultTemplates"), import_getThemeSuitePalettes2 = require("./getThemeSuitePalettes"), import_v4_defaultTemplates2 = require("./v4-defaultTemplates"), defaultPalettes = createPalettes(getThemesPalettes({
  base: {
    palette: [
      "#fff",
      "#000"
...
function createThemeSuite(props) {
  var { accent, childrenThemes, grandChildrenThemes, templates = import_v4_defaultTemplates.defaultTemplates, componentThemes = defaultComponentThemes } = props, builder = createSimpleThemeBuilder({
...
function createSimpleThemeBuilder(props) {
  var { extra, childrenThemes = null, grandChildrenThemes = null, templates = import_v4_defaultTemplates.defaultTemplates, palettes = defaultPalettes, componentThemes = templates === import_v4_defaultTemplates.defaultTemplates ? defaultComponentThemes : void 0 } = props, themeBuilder = (0, import_theme_builder.createThemeBuilder)().addPalettes(palettes).addTemplates(templates).addThemes({
    light: {
      template: "base",
      palette: "light",
