...
var import_colors = require("@tamagui/colors"), import_v4_createTheme = require("./v4-createTheme"), colorTokens = {
  light: {
...
}, lightShadowColor = "rgba(0,0,0,0.04)", lightShadowColorStrong = "rgba(0,0,0,0.085)", darkShadowColor = "rgba(0,0,0,0.2)", darkShadowColorStrong = "rgba(0,0,0,0.3)", darkPalette = [
  "#050505",
  "#fff"
], lightPalette = [
  "#fff",
  "hsl(0, 0%, 9.0%)"
], defaultThemes = (0, import_v4_createTheme.createThemeSuite)({
  base: {
    palette: {
      dark: darkPalette,
      light: lightPalette
