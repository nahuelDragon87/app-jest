...
function createTamaguiAnimatedComponent() {
  var defaultTag = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "div", isText = defaultTag === "span", Component = Animated.createAnimatedComponent(/* @__PURE__ */ forwardRef(function(propsIn, ref) {
    var _hooks_usePropsTransform, { forwardedRef, animation, tag = defaultTag, ...propsRest } = propsIn, hostRef = useRef(), composedRefs = useComposedRefs(forwardedRef, ref, hostRef), stateRef = useRef();
    stateRef.current || (stateRef.current = {
      get host() {
        return hostRef.current;
      }
    });
    var [{ state }] = useThemeWithState({}), result = getSplitStyles(propsRest, isText ? Text.staticConfig : View.staticConfig, state?.theme, state?.name, {
      unmounted: !1
    }, {
      isAnimated: !1,
      noClass: !0
    }), props = result.viewProps, Element = tag, transformedProps = (_hooks_usePropsTransform = hooks.usePropsTransform) === null || _hooks_usePropsTransform === void 0 ? void 0 : _hooks_usePropsTransform.call(hooks, tag, props, stateRef, !1);
