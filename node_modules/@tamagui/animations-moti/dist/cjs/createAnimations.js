...
var import_use_presence = require("@tamagui/use-presence"), import_web = require("@tamagui/web"), import_author = require("moti/author"), import_react = __toESM(require("react")), import_react_native_reanimated = __toESM(require("react-native-reanimated")), import_jsx_runtime = require("react/jsx-runtime");
function createTamaguiAnimatedComponent(defaultTag = "div") {
  const isText = defaultTag === "span", Component = import_react_native_reanimated.default.createAnimatedComponent(
    (0, import_react.forwardRef)((propsIn, ref) => {
      const { forwardedRef, animation, tag = defaultTag, ...propsRest } = propsIn, hostRef = (0, import_react.useRef)(), composedRefs = (0, import_web.useComposedRefs)(forwardedRef, ref, hostRef), stateRef = (0, import_react.useRef)();
      stateRef.current || (stateRef.current = {
        get host() {
          return hostRef.current;
        }
      });
      const [{ state }] = (0, import_web.useThemeWithState)({}), props = (0, import_web.getSplitStyles)(
        propsRest,
      ...
      ).viewProps, Element = tag, transformedProps = import_web.hooks.usePropsTransform?.(tag, props, stateRef, !1);
...
function createAnimations(animations) {
  return {
    ...
    useAnimations: (animationProps) => {
      ...
      const styles = animate, isExiting = !!presence?.[1], presenceContext = import_react.default.useContext(import_use_presence.PresenceContext), usePresenceValue = presence || void 0;
