...
export function dependenciesToFixedSummary(dependencies) {
    ...
    return `Fixed versions for ${dependenciesAndFixedVersions.length} ${dependenciesAndFixedVersions.length === 1 ? 'dependency' : 'dependencies'}: ${dependenciesAndFixedVersions
